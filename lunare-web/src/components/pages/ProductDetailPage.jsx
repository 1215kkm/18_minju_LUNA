...
const products = {
  ...
  'lilac-glow': {
    ...
    textureText:
      '얇은 파우더 밤이 피부에 가볍게 밀착되어,\n들뜸 없이 보송하고 은은한 라일락 광을 남깁니다.',
    howTo:
  ...
  'blue-haze': {
    ...
    textureText:
      '가볍고 투명한 밤 텍스쳐가 피부 위에서 얇게 녹아,\n파우더리하지 않은 맑은 블루 펄만 남깁니다.',
    howTo:
        ...
        <section className="mx-auto mt-8 max-w-[1240px] overflow-hidden md:mt-12">
          <div className="flex flex-col lg:flex-row">
            ...
            >
              ...
              <p className="mb-6 whitespace-pre-line font-pretendard text-[16px] font-light leading-[1.65] text-[#2d2932] sm:text-[18px] lg:mb-10 lg:max-w-[420px] lg:text-[20px]">
                {product.textureText}
              </p>
